...
class API {
    ...
    createVersion(body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.post(`https://${this.domain}.atlassian.net/rest/api/3/version`, body, {
    ...
    updateVersion(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield axios_1.default.put(`https://${this.domain}.atlassian.net/rest/api/3/version/${id}`, body, { headers: this._headers() });
                return response.data;
            }
            catch (error) {
                return Promise.reject((0, utils_1.toMoreDescriptiveError)(error));
    ...
    updateIssue(ticket_id, version_id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.put(`https://${this.domain}.atlassian.net/rest/api/3/issue/${ticket_id}`, {
                    update: {
                        fixVersions: [
                            {
                                add: { id: version_id }
    ...
    loadProject() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.get(`https://${this.domain}.atlassian.net/rest/api/3/project/${this.name}?properties=versions,key,id,name`, { headers: this._headers() });
                return response.data;
            }
            catch (error) {
                return Promise.reject((0, utils_1.toMoreDescriptiveError)(error));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UPDATING_TICKET = exports.PROJECT_LOADED = exports.VERSION_WILL_BE_UPDATED = exports.VERSION_WILL_BE_CREATED = exports.VERSION_FOUND = exports.VERSION_NOT_FOUND = void 0;
const VERSION_NOT_FOUND = (version) => `Version ${version} not found`;
exports.VERSION_NOT_FOUND = VERSION_NOT_FOUND;
const VERSION_FOUND = (version) => `Version ${version} found`;
exports.VERSION_FOUND = VERSION_FOUND;
const VERSION_WILL_BE_CREATED = (version) => `Version ${version} is going to the created`;
exports.VERSION_WILL_BE_CREATED = VERSION_WILL_BE_CREATED;
const VERSION_WILL_BE_UPDATED = (version) => `Version ${version} found and is going to be updated`;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RELEASE = exports.CREATE = exports.DRY_RUN = exports.TICKETS = exports.PROJECT = exports.RELEASE_NAME = exports.SUBDOMAIN = exports.API_TOKEN = exports.EMAIL = void 0;
const core_1 = __nccwpck_require__(2186);
// Jira API credentials
exports.EMAIL = (0, core_1.getInput)('email', { required: true });
exports.API_TOKEN = (0, core_1.getInput)('api_token', { required: true });
exports.SUBDOMAIN = (0, core_1.getInput)('subdomain', { required: true });
// Release information
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (env_1.DRY_RUN === 'ci') {
                (0, core_1.info)(`email ${env_1.EMAIL}`);
                (0, core_1.info)(`project ${env_1.PROJECT}`);
                (0, core_1.info)(`subdomain ${env_1.SUBDOMAIN}`);
                (0, core_1.info)(`release ${env_1.RELEASE_NAME}`);
                (0, core_1.info)(`create ${env_1.CREATE}`);
                (0, core_1.info)(`tickets ${env_1.TICKETS}`);
                (0, core_1.info)(`release ${env_1.RELEASE}`);
                return;
            }
            if (env_1.DRY_RUN === 'true') {
                ...
                const project = yield api.loadProject();
            ...
            const api = new api_1.API(env_1.EMAIL, env_1.API_TOKEN, env_1.PROJECT, env_1.SUBDOMAIN);
            const project = yield api.loadProject();
            (0, core_1.debug)(DebugMessages.PROJECT_LOADED(project.id));
            let version = project.versions.find((v) => v.name === env_1.RELEASE_NAME);
            const release = env_1.RELEASE === true;
            if (version === undefined) {
                (0, core_1.debug)(DebugMessages.VERSION_NOT_FOUND(env_1.RELEASE_NAME));
                if (env_1.CREATE === true) {
                    (0, core_1.debug)(DebugMessages.VERSION_WILL_BE_CREATED(env_1.RELEASE_NAME));
                    const versionToCreate = Object.assign({ name: env_1.RELEASE_NAME, released: release, projectId: Number(project.id) }, (release && { releaseDate: new Date().toISOString() }));
                    version = yield api.createVersion(versionToCreate);
                    (0, core_1.debug)(versionToCreate.name);
                }
            }
            else {
                (0, core_1.debug)(DebugMessages.VERSION_WILL_BE_UPDATED(env_1.RELEASE_NAME));
                const versionToUpdate = {
                    released: release,
                    releaseDate: new Date().toISOString()
                };
                version = yield api.updateVersion(version.id, versionToUpdate);
            }
            if (env_1.TICKETS !== '') {
                const tickets = env_1.TICKETS.split(',');
                for (const ticket of tickets) {
                    (0, core_1.debug)(DebugMessages.UPDATING_TICKET(ticket));
                    if ((version === null || version === void 0 ? void 0 : version.id) !== undefined) {
                        api.updateIssue(ticket, version === null || version === void 0 ? void 0 : version.id);
                    }
                }
            }
        }
...
const toMoreDescriptiveError = (error) => {
    ...
    if (isAxiosError(error) &&
        Number((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) >= 400 &&
        Number((_b = error.response) === null || _b === void 0 ? void 0 : _b.status) < 500 &&
        Array.isArray((_c = error.response) === null || _c === void 0 ? void 0 : _c.data.errorMessages)) {
        return new Error((_d = error.response) === null || _d === void 0 ? void 0 : _d.data.errorMessages[0]);
    }
    else {
