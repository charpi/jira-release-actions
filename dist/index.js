...
class Project {
    ...
    updateVersion(version) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                core_1.debug(JSON.stringify(version));
...
const toMoreDescriptiveError = (error) => {
    var _a, _b, _c;
    if (isAxiosError(error) && ((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) === 404 && Array.isArray((_b = error.response.data) === null || _b === void 0 ? void 0 : _b.errorMessages)) {
...
exports.EMAIL = core_1.getInput('email', { required: true });
exports.API_TOKEN = core_1.getInput('api_token', { required: true });
exports.SUBDOMAIN = core_1.getInput('subdomain', { required: true });
// Release information
exports.RELEASE_NAME = core_1.getInput('release_name', { required: true });
exports.PROJECT = core_1.getInput('jira_project', { required: true });
exports.TICKETS = core_1.getInput('tickets', { required: false });
// Github actions
exports.DRY_RUN = core_1.getInput('dry_run', { required: false });
exports.CREATE = core_1.getBooleanInput('create', { required: false });
exports.RELEASE = core_1.getBooleanInput('release', { required: false });
...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (env_1.DRY_RUN === 'ci') {
                core_1.info(`email ${env_1.EMAIL}`);
                core_1.info(`project ${env_1.PROJECT}`);
                core_1.info(`subdomain ${env_1.SUBDOMAIN}`);
                core_1.info(`release ${env_1.RELEASE_NAME}`);
                core_1.info(`create ${env_1.CREATE}`);
                core_1.info(`tickets ${env_1.TICKETS}`);
                core_1.info(`release ${env_1.RELEASE}`);
                return;
            }
            if (env_1.DRY_RUN === 'true') {
                ...
                core_1.info(`Project loaded ${(_a = project.project) === null || _a === void 0 ? void 0 : _a.id}`);
                const version = project.getVersion(env_1.RELEASE_NAME);
                if (version === undefined) {
                    core_1.info(`Version ${env_1.RELEASE_NAME} not found`);
                }
                else {
                    core_1.info(`Version ${env_1.RELEASE_NAME} found`);
                }
                return;
            }
            const project = yield api_1.Project.create(env_1.EMAIL, env_1.API_TOKEN, env_1.PROJECT, env_1.SUBDOMAIN);
            core_1.debug(`Project loaded ${(_b = project.project) === null || _b === void 0 ? void 0 : _b.id}`);
            let version = project.getVersion(env_1.RELEASE_NAME);
            const release = env_1.RELEASE === true;
            if (version === undefined) {
                core_1.debug(`Version ${env_1.RELEASE_NAME} not found`);
                if (env_1.CREATE === true) {
                    core_1.debug(`Version ${env_1.RELEASE_NAME} is going to the created`);
                    ...
                    core_1.debug(versionToCreate.name);
                }
            }
            else {
                core_1.debug(`Version ${env_1.RELEASE_NAME} found and is going to be updated`);
                const versionToUpdate = Object.assign(Object.assign({}, version), { self: undefined, released: release, releaseDate: new Date().toISOString(), userReleaseDate: undefined });
            ...
            if (env_1.TICKETS !== '') {
                ...
                tickets.forEach((ticket) => {
                    core_1.debug(`Going to update ticket ${ticket}`);
